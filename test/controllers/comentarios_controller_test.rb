...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { arquivo: @comentario.arquivo, denuncia_id: @comentario.denuncia_id, descricao: @comentario.descricao, usuario_id: @comentario.usuario_id } }, as: :json
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { arquivo: @comentario.arquivo, denuncia_id: @comentario.denuncia_id, descricao: @comentario.descricao, usuario_id: @comentario.usuario_id } }, as: :json
    assert_response 200
  end
